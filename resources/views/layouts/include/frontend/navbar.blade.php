        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                    <h5 class="brand-name">ePurity</h5>
                </div>
                    ...
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                                <i class="fa fa-shopping-cart"></i> Kranjang (0)
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/kategoriall')}}">Kategori</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/baru')}}">Baru</a>
                    </li>
                    <li class="nav-item">
